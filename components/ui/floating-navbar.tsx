...
//         "dark:text-zinc-200"
//       );
//       talkToUsBtn &&  talkToUsBtn.classList.add(NAVBAR_CLASSES.talkToUsBtn);
//     };

//     const handleMouseLeave = () => {
//       talkToUsBtn && talkToUsBtn.classList.remove(NAVBAR_CLASSES.talkToUsBtn);
...
//   return (
//     <nav
//       className={`text-white hero sticky top-0 z-50 transition-transform duration-200 ${
//         visible ? "transform translate-y-0 bg-gray-800 bg-opacity-70" : "transform -translate-y-full"
//       }`}
//     >
...
//             Login
//           </a>
//           <button id="talkToUsBtn" className={NAVBAR_CLASSES.button}>
//             Talk to Us
//           </button>
//         </div>
//       </div>
